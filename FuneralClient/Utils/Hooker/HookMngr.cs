...
namespace PlayHooky
{
    ...
    /// <summary>
    /// HookMgr. Used to hook and unhook all hooked functions in a process. No method in this class is thread safe and should be shared among all threads (protected by a Lock).
    /// 
    ...
    public class HookMgr
    {
        ...
        /// <summary>
        /// Creates a HookMgr. HookMgr is not thread safe. If it is to be used from multiple threads, one instance should be shared among all threads
        /// with a lock.
        /// </summary>
